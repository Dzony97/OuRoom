...
urlpatterns = [
    ...
    path('ouroom/group/<int:group_id>', views.PostGroupListView.as_view(), name='group_posts'),
    path('group/<int:group_id>/member/<int:member_id>/delete', views.member_delete, name='member_delete'),
